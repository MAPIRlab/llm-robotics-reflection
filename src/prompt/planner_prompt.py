...
Read and parse the JSON in order to answer a user query about the scene, indicating the list of most related objects to perform the task.
This list should be sorted according to relevance, with the most relevant object first and the least relevant object last.
To answer the user query, you must not only take into account the classification result of each object, but also the arrangement of these objects in the semantic map.
